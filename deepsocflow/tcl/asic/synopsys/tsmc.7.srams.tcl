...
exec rf_sp_hde_svt_mvt all -atf off -activity_factor 50 -back_biasing off -bits $EDGE_BITS -flexible_banking $SRAM_EDGES_BANKS -flexible_slice $SRAM_EDGES_SLICES -bmux off -bus_notation on -check_instname on -corners $CORNERS -cust_comment "" -diodes on -drive 6 -ema on -frequency $FREQ -instname sram_edges -left_bus_delim {[} -libertyviewstyle nldm -libname SRAM_EDGES -mux $SRAM_EDGE_MUX -name_case upper -power_type otc -prefix "" -pwr_gnd_rename vddpe:VDD,vddce:VDD,vsse:VSS -retention on -right_bus_delim {]} -ser none -site_def off -top_layer m5-m10 -words $SRAM_EDGES_EST_DEPTH -write_mask off -write_thru off -power_gating off -redundancy off -pipeline off -scan off -vmin_assist off
exec rf_sp_hde_svt_mvt liberty -atf off -activity_factor 50 -back_biasing off -bits $EDGE_BITS -flexible_banking $SRAM_EDGES_BANKS -flexible_slice $SRAM_EDGES_SLICES -bmux off -bus_notation on -check_instname on -corners $CORNERS -cust_comment "" -diodes on -drive 6 -ema on -frequency $FREQ -instname sram_edges -left_bus_delim {[} -libertyviewstyle nldm -libname SRAM_EDGES -mux $SRAM_EDGE_MUX -name_case upper -power_type otc -prefix "" -pwr_gnd_rename vddpe:VDD,vddce:VDD,vsse:VSS -retention on -right_bus_delim {]} -ser none -site_def off -top_layer m5-m10 -words $SRAM_EDGES_EST_DEPTH -write_mask off -write_thru off -power_gating off -redundancy off -pipeline off -scan off -vmin_assist off
cd ../../../work

#Genrating SRAM WEIGHTS
cd ../asic/srams/sram_weights
exec rf_sp_hde_svt_mvt all -atf off -activity_factor 50 -back_biasing off -bits $WEIGHT_BITS -flexible_banking $SRAM_WEIGHTS_BANKS -flexible_slice $SRAM_WEIGHTS_SLICES -bmux off -bus_notation on -check_instname on -corners $CORNERS -cust_comment "" -diodes on -drive 6 -ema on -frequency $FREQ -instname sram_weights -left_bus_delim {[} -libertyviewstyle nldm -libname SRAM_WEIGHTS -mux $SRAM_WEIGHT_MUX -name_case upper -power_type otc -prefix "" -pwr_gnd_rename vddpe:VDD,vddce:VDD,vsse:VSS -retention on -right_bus_delim {]} -ser none -site_def off -top_layer m5-m10 -words $SRAM_WEIGHTS_EST_DEPTH -write_mask off -write_thru off -power_gating off -redundancy off -lren_bankmask off -pipeline off -scan off -vmin_assist off
exec rf_sp_hde_svt_mvt liberty -atf off -activity_factor 50 -back_biasing off -bits $WEIGHT_BITS -flexible_banking $SRAM_WEIGHTS_BANKS -flexible_slice $SRAM_WEIGHTS_SLICES -bmux off -bus_notation on -check_instname on -corners $CORNERS -cust_comment "" -diodes on -drive 6 -ema on -frequency $FREQ -instname sram_weights -left_bus_delim {[} -libertyviewstyle nldm -libname SRAM_WEIGHTS -mux $SRAM_WEIGHT_MUX -name_case upper -power_type otc -prefix "" -pwr_gnd_rename vddpe:VDD,vddce:VDD,vsse:VSS -retention on -right_bus_delim {]} -ser none -site_def off -top_layer m5-m10 -words $SRAM_WEIGHTS_EST_DEPTH -write_mask off -write_thru off -power_gating off -redundancy off -lren_bankmask off -pipeline off -scan off -vmin_assist off
cd ../../../work
