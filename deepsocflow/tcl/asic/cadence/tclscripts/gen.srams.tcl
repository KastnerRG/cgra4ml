...
# Generate Folders
exec mkdir -p ../../../PDK/$FOUNDARY$TECHNOLOGY/SRAM_Inst
exec mkdir -p ../../../PDK/$FOUNDARY$TECHNOLOGY/SRAM_Inst/sram_dma
exec mkdir -p ../../../PDK/$FOUNDARY$TECHNOLOGY/SRAM_Inst/sram_edges
exec mkdir -p ../../../PDK/$FOUNDARY$TECHNOLOGY/SRAM_Inst/sram_weights

#Genrating SRAM EDGES
cd ../../../PDK/$FOUNDARY$TECHNOLOGY/SRAM_Inst/sram_edges
...
cd ../../../PDK/$FOUNDARY$TECHNOLOGY/SRAM_Inst/sram_weights
...
#Genrating SRAM DMA
cd ../../../PDK/$FOUNDARY$TECHNOLOGY/SRAM_Inst/sram_dma
