...
# Generate Folders
exec mkdir -p ../../../PDK/TSMC28HPCPLUS/SRAM_Inst_old_cgra4ml
exec mkdir -p ../../../PDK/TSMC28HPCPLUS/SRAM_Inst_old_cgra4ml/sram_edges
exec mkdir -p ../../../PDK/TSMC28HPCPLUS/SRAM_Inst_old_cgra4ml/sram_weights

#Genrating SRAM EDGES
cd ../../../PDK/TSMC28HPCPLUS/SRAM_Inst_old_cgra4ml/sram_edges
...
cd ../../../PDK/TSMC28HPCPLUS/SRAM_Inst_old_cgra4ml/sram_weights
