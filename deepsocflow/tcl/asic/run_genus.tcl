...
#--------- LIBRARIES
set_db library "../asic/pdk/tsmc65lp/lib/sc12_cln65lp_base_rvt_ss_typical_max_1p08v_125c.lib ../asic/srams/sram_weights/sram_weights_ss_1p08v_1p08v_125c.lib ../asic/srams/sram_edges/sram_edges_ss_1p08v_1p08v_125c.lib"

set_db lef_library { ../asic/pdk/tsmc65lp/lef/sc12_tech.lef ../asic/pdk/tsmc65lp/lef/sc12_cln65lp_base_rvt.lef ../asic/srams/sram_weights/sram_weights.lef ../asic/srams/sram_edges/sram_edges.lef}

set_db cap_table_file ../asic/pdk/tsmc65lp/qrc/typical.captbl

#--------- READ
read_hdl -language sv ../../deepsocflow/rtl/defines.svh
...
write_sdf > ../asic/outputs/${TOP}.out.sdf
