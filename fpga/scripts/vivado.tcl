...
# AXI Lite
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config "[concat { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master} $PS_M_AXI_LITE {Slave {/dma_pixels/S_AXI_LITE} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}} ]"  [get_bd_intf_pins dma_pixels/S_AXI_LITE]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config "[concat { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master} $PS_M_AXI_LITE {Slave {/dma_weights_out/S_AXI_LITE} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}} ]"  [get_bd_intf_pins dma_weights_out/S_AXI_LITE]

# AXI Full
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config "[concat { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/dma_pixels/M_AXI_MM2S} Slave } $PS_S_AXI { ddr_seg {Auto} intc_ip {New AXI SmartConnect} master_apm {0}} ]"  [get_bd_intf_pins ${PS_S_AXI}]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config "[concat { Clk_master {Auto} Clk_slave } $PS_CLK { Clk_xbar } $PS_CLK { Master {/dma_weights_out/M_AXI_MM2S} Slave } $PS_S_AXI { ddr_seg {Auto} intc_ip {/axi_smc} master_apm {0}} ]" [get_bd_intf_pins dma_weights_out/M_AXI_MM2S]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config "[concat { Clk_master {Auto} Clk_slave } $PS_CLK { Clk_xbar } $PS_CLK { Master {/dma_weights_out/M_AXI_S2MM} Slave } $PS_S_AXI { ddr_seg {Auto} intc_ip {/axi_smc} master_apm {0}} ]" [get_bd_intf_pins dma_weights_out/M_AXI_S2MM]
