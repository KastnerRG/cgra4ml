...
`define UNITS_EDGES        12
`define OUT_SHIFT_MAX      8
`define IM_SHIFT_REGS      6
...
`define BITS_IM_BLOCKS    7   
`define BITS_IM_SHIFT     2   
`define BITS_IM_SHIFT_REGS 3   
...
`define DATA_BYTES_axis_clk_conv_dw    32    
`define DATA_BYTES_axis_clk_lrelu      8      
`define DATA_BYTES_axis_clk_maxpool    32    

`define S_BYTES_axis_dw_image_input    8 
`define M_BYTES_axis_dw_image_input    12 
`define TLAST_axis_dw_image_input      1   
`define TKEEP_axis_dw_image_input      1   

`define DATA_BYTES_axis_reg_slice_image_pipe  2 
...
`define TUSER_WIDTH_axis_dw_lrelu_1_active 15 
...
`define S_BYTES_axis_dw_lrelu_2            32            
`define M_BYTES_axis_dw_lrelu_2            4            
`define TUSER_WIDTH_axis_dw_lrelu_2_active 15  
...
`define DATA_BYTES_axis_reg_slice_lrelu_dw   8    
`define TID_WIDTH_axis_reg_slice_lrelu_dw    15     
...
`define DATA_BYTES_axis_reg_slice_lrelu  8  
...
`define S_BYTES_axis_dw_lrelu 8
`define M_BYTES_axis_dw_lrelu 8
`define TLAST_axis_dw_lrelu   1  
`define TKEEP_axis_dw_lrelu   1  

`define S_BYTES_axis_dw_max_1 48
`define M_BYTES_axis_dw_max_1 24
`define TLAST_axis_dw_max_1   1  
`define TKEEP_axis_dw_max_1   1  

`define S_BYTES_axis_dw_max_2 24
`define M_BYTES_axis_dw_max_2 32
`define TLAST_axis_dw_max_2   1  
`define TKEEP_axis_dw_max_2   1  

`define DATA_BYTES_axis_reg_slice_maxpool 8
