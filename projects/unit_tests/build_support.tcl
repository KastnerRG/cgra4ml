...
create_ip -name axis_dwidth_converter -vendor xilinx.com -library ip -version 1.1 -module_name axis_dwidth_converter_0 -dir {$PROJ_FOLDER/$PROJ_NAME.srcs/sources_1/ip}
set_property -dict [list CONFIG.S_TDATA_NUM_BYTES {24} CONFIG.M_TDATA_NUM_BYTES {4} CONFIG.HAS_TLAST {1} CONFIG.HAS_TKEEP {1}] [get_ips axis_dwidth_converter_0]
