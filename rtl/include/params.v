...
`define FREQ_HIGH     600
`define FREQ_RATIO    1

`define UNITS_EDGES        17
`define OUT_SHIFT_MAX      32
`define IM_SHIFT_REGS      11
...
`define M_DATA_WIDTH_HF_CONV    16128   
`define M_DATA_WIDTH_HF_CONV_DW 168
`define M_DATA_WIDTH_LF_CONV_DW 256
`define M_DATA_WIDTH_HF_LRELU   56  
`define M_DATA_WIDTH_LF_LRELU   64  
`define M_DATA_WIDTH_HF_MAXPOOL 136
`define M_DATA_WIDTH_HF_MAX_DW1 136
